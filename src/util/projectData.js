const projectData = [
  ...
  {
    title: 'GoPursue',
    description: 'Career exploration SAAS app developed using RAILS and REACT and deployed with HEROKU and AWS S3.',
    links:
        {
  ...
  {
    title: 'Bomb Squad',
    description: 'Minesweeper-style game made with vanilla JS, HTML, and CSS. This was my first project.',
    links:
        {
          github: 'https://github.com/camouflagedName/Bomb-Squad',
  ...
  {
    title: 'Color Grid',
    description: 'Random color generator made with REACT and deployed with AMPLIFY',
    links:
        {
  ...
  {
    title: 'Covid App',
    description: 'Mobile app to upload pictures developed with REACT NATIVE and EXPO',
    links:
        {
          github: 'https://github.com/camouflagedName/covid_app',
          website: '',
        },
    date: 'March 2022',
    stack: ["native", "expo"],
